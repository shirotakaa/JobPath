...
===========================*/	
	...
	document.addEventListener('scroll', function () {
        ...
        const dropdownToggle = document.querySelector('#ID-ACCOUNT_dropdown');
    ...
    document.querySelectorAll(".toggle-password").forEach(icon => {
        icon.addEventListener("click", function () {
            ...
            if (input.type === "password") {
                ...
                this.classList.replace("fa-eye-slash", "fa-eye"); // Ganti ikon
            } else {
                input.type = "password"; // Menyembunyikan password
                this.classList.replace("fa-eye", "fa-eye-slash"); // Ganti ikon
            }
        });
    });
